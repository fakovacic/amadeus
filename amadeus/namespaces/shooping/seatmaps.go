...
const (
	...
	// Seatmap Display
	//
	seatmapsURL = "/shopping/seatmaps"
)

type SeatmapsRequest struct {
	FlightOrderID string                `json:"flightOrderID,omitempty"`
	FlightOffers  []structs.FlightOffer `json:"data,omitempty"`
}

// SetFlightOrderID set flight order ID
func (sR *SeatmapsRequest) SetFlightOrderID(id string) *SeatmapsRequest {
...
func (sR *SeatmapsRequest) AddOffer(offer structs.FlightOffer) *SeatmapsRequest {
...
func (sR SeatmapsRequest) GetURL(reqType string) string {
...
// SetParam set params
func (dR *SeatmapsRequest) SetParam(key, value string) {
	return
}

// GetBody prepare struct values to slice
// returned key=value format for request on api
func (sR SeatmapsRequest) GetBody(reqType string) io.Reader {
...
func (dR *SeatmapsResponse) Decode(rsp []byte) error {
...
type SeatData struct {
	...
	Aircraft      structs.Aircraft `json:"aircraft,omitempty"`
...
type Seats struct {
	...
	TravelerPricing      []structs.TravelerPricing `json:"travelerPricing,omitempty"`
	Coordinates          Coordinates               `json:"coordinates,omitempty"`
}
